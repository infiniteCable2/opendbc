...
class IntelligentCruiseButtonManagementInterface(IntelligentCruiseButtonManagementInterfaceBase):
  ...
  def update(self, CC_SP, CS, packer, bus_send) -> list[CanData]:
    can_sends = []
    self.CC_SP = CC_SP
    ...
    if CS.out.cruiseState.enabled and (up or down):
      can_sends.append(self.CCS.create_acc_buttons_control(packer, bus_send, CS.gra_stock_values, up=up, down=down))
