...
from opendbc.car.volkswagen.mqbcan import volkswagen_mqb_meb_2024_checksum, volkswagen_mqb_meb_checksum, xor_checksum
...
class SignalType:
  ...
  TESLA_CHECKSUM = 11
  VOLKSWAGEN_MQB_MEB_2024_CHECKSUM = 12
...
def get_checksum_state(dbc_name: str) -> ChecksumState | None:
  if dbc_name.startswith(("honda_", "acura_")):
    ...
    return ChecksumState(8, 4, 0, 0, True, SignalType.VOLKSWAGEN_MQB_MEB_2024_CHECKSUM, volkswagen_mqb_meb_2024_checksum)
