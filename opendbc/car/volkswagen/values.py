  ...
  def __init__(self, CP):
    ...
    if CP.flags & VolkswagenFlags.PQ:
      ...
      self.BUTTONS = [
        ...
        Button(structs.CarState.ButtonEvent.Type.cancel, "GRA_ACC_01", "GRA_Abbrechen", [1]), # there is no physical cancel button for older models
        Button(structs.CarState.ButtonEvent.Type.cancel, "GRA_ACC_01", "GRA_Hauptschalter", [1]), # main button cancels ACC operation when ACC active fo older models
