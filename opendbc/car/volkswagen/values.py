...
from opendbc.car import Bus, CanBusBase, CarSpecs, DbcDict, PlatformConfig, Platforms, structs, uds, car
...
class CarControllerParams:
  ...
  def __init__(self, CP):
    ...
    if CP.flags & VolkswagenFlags.PQ:
      ...
      self.CURVATURE_PID = car.CarParams.LateralPIDTuning.new_message()
